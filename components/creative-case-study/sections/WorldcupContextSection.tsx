...
export function WorldcupContextSection() {
  return (
    <ScaledCanvas designHeight={DESIGN_H} className="wc-s1">
      ...
      <FigmaPlacement designHeight={DESIGN_H} x={118.87} y={378.79} w={205.44}>
        <h2 className="wc-s1__heading">团队分工：</h2>
      </FigmaPlacement>

      <FigmaPlacement designHeight={DESIGN_H} x={119} y={445} w={733}>
        <div className="wc-s1__body wc-s1__body--roles">
          <p>
          ...
          <p>【独立主导】 3大核心增长玩法视觉设计</p>
          <p>【核心共建】 2大高频裂变玩法设计（50%）</p>
          <p>【效率延展】 全渠道推广物料系统化延展</p>
          <p>
